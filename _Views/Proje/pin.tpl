...
<!-- page content -->
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <textarea style="resize:vertical;" class="form-control" rows="5" name="Yazi"></textarea>
                    <br>
  ...
  <input name="filesToUpload" id="filesToUpload" type="file" accept=".doc,.docx,.xml,.xls,.xlsx,image/*,.psd,.txt,.ppt,.pptx,.pps,.pdf,.mp3"/><br>
  <button type="submit" class="btn btn-primary" name="submit" id="submit">{$ADD_PANO}</button>
</form>
