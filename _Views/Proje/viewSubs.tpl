                      ...
                      <tbody>
                          ...
                          {foreach $abonelerDizi as $r} 
                            <tr data-id="{$r.DersID}">
                              ...
                              <td>
                                <a href="#" onclick="AboneliktenCikart({$r.AbonelikID})" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> {$KIC} </a>
                              </td>
                            </tr>
                            {foreachelse}
                            .. {$NO_RESULT} .. 
