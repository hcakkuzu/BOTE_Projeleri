...
<!-- Load Lang Files -->
{if $LANG == 'tr'} {include file='Proje/_lang_TR.tpl' scope=parent} {block name="title"}Aboneler | BÖTE Projeleri{/block}
{else} {include file='Proje/_lang_EN.tpl' scope=parent} {block name="title"}Subscribers | CEIT Projects{/block} {/if} {block
name="head"}
<!-- NProgress -->
...
<link href="../_Vendors/Proje/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet"> {/block} {block name="body"}
<!-- page content -->
            ...
            <div class="x_content">
              {if isset($smarty.post.submit)}
                  <p class="alert alert-info">
                    ...
                    {/if}
                    {if {$PASS}=='false'}
                      Eski Parola Hatalı Yada Başka Bir Sorun Var.
                    {/if}
                  </p>
              {/if}

              <div class="form-group">
                <label class="col-md-4 control-label" for="piCurrPass">Eski Parola</label>

                <input id="piCurrPass" name="eskiPass" type="password" placeholder="" class="form-control input-md" required="">
              ...
              <!-- Password input-->
              <div class="form-group">
                <label class="col-md-4 control-label" for="piNewPass">Yeni Parola</label>

                <input id="piNewPass" name="yeniPass" type="password" placeholder="" class="form-control input-md" required="">


              </div>

              <div class="form-group">
                <button class="btn btn-md btn-primary" type="submit" name="submit">Gönder</button>
              </div>
...
<script>
  $(document).ready(function () {
    ...
    $('#reportrange_right').on('apply.daterangepicker', function (ev, picker) {
      console.log("apply event fired, start/end dates are " + picker.startDate.format('MMMM D, YYYY') + " to " +
